const propiedadesJSON = [
  ...
  const cantidadCuartos = document.querySelector("#cuartos");
  ...
  function buscar(filtrar) {
    ...
    for (const propiedad of propiedadesJSON) {
      if(propiedad.rooms <= Number(cantidadCuartos.value) &&
  ...
  function insertar(propiedad) {
    ...
    clone.querySelector(".img").style.backgroundImage = "url('"+ propiedad.src+"')";
    clone.querySelector(".name").innerText = propiedad.name;
    clone.querySelector(".rooms").innerText = "Cuartos: " + propiedad.rooms;
